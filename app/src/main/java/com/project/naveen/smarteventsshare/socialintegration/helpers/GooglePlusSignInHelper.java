package com.project.naveen.smarteventsshare.socialintegration.helpers;
...
public class GooglePlusSignInHelper {
    ...
    public interface OnGoogleSignInListener {
        ...
        public void initialize(Context activity, OnGoogleSignInListener onGoogleSignInListener)
        {
                    ...
                    Plus.PeopleApi.load(googleApiClient, acct.getId()).setResultCallback(new ResultCallback<People.LoadPeopleResult>() {
                        ...
                        public void onResult(@NonNull People.LoadPeopleResult loadPeopleResult) {
                            ...
                            if (loginResultCallback != null) {
                                ...
                                Log.e(TAG, "loginResultCallback = null");
                        }
                    });
                }
                else
